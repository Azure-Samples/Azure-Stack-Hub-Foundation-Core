...
# DEPLOYMENT VALUES #
#####################
$DeploymentName = "MediumLoad"
$ResourceGroupName = "RG-MEDIUMLOAD"
...
########################
[string] $vnetName = "MediumVirtualNetwork"
...
# JUMPHOST VNET #
#################
[string] $jumphostvnetName = "MediumJumphostVirtualNetwork"
...
######################################
[string] $adcVirtualMachineName = "MD-LOCAL-AD01"
[string] $adcDomainName = "MEDIUM.LOCAL"
[string] $adcNetworkInterfaceName = "MD-LOCAL-AD01-NIC"
...
# JUMP HOST VALUES #
####################
[string] $jpPublicIpName = "medium-jumphost-pip1d"
[string] $jpPublicIpSku = "Basic"
[string] $jpPublicIPAllocationMethod = "Dynamic"
[string] $jpDnsLabelPrefix = "mediumjumphost"
[string] $jpNetworkInterfaceName = "medium-jumphost-nic1d"
[string] $jpVirtualMachineSize = "Standard_F2s_v2"
[string] $jpVirtualMachineName = "medium-Jumphost"
...
$Standard_A1_v2 = @{
    ...
    VirtualMachineNamePrefix = "MLA1V2"
...
$Standard_F2s_v2 = @{
    VirtualMachineCount      = 50
    ParallelDeployments      = 25
    VirtualMachineNamePrefix = "MLF2SV2"
    Publisher                = "MicrosoftSQLServer"
...
$Standard_DS5_v2 = @{
    ...
    VirtualMachineNamePrefix = "MLDS5V2"
    Offer                    = "SQL2016SP2-WS2016"
    Publisher                = "MicrosoftSQLServer"
    SKU                      = "Enterprise"
    ManagedDisk              = "true"
...
$Standard_D3_v2 = @{
    VirtualMachineCount      = 5
    ParallelDeployments      = 5
    VirtualMachineNamePrefix = "MLD3V2"
...
$Standard_D3_v2_Cluster = @{
    AmountOfClusters                   = 5
    ParallelDeployments                = 5
    StartIndex                         = 0
    VirtualMachineNamePrefix           = "MLD3V2"
    VirtualMachineSize                 = "Standard_D3_v2" 
    FileShareWitnessVmSize             = "Standard_D3_v2" 
    ManagedDisk                        = "true"
    StorageAccountType                 = "Standard_LRS"
    FileShareWitnessStorageAccountType = "Standard_LRS"
    AmountOfSqlDisks                   = 3
...
$DeploymentList.Add($Standard_D3_v2_Cluster)
